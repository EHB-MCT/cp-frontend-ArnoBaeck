...
function Scene2_Door({ onTransitionEnd, onHide }) {
	...
	}, [doorOpen, showWitch, witchCloseUp, startDarkTransition, onTransitionEnd, onHide]);
	...
	return (
		<>
			...
			<motion.div
				...
				initial={{ opacity: 0 }}
				animate={{ opacity: startDarkTransition ? 1 : 0 }}
				transition={{ duration: 1 }}
			/>
		</>
	);
